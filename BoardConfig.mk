...
TARGET_BOOTLOADER_BOARD_NAME := S11     # From ro.product.board
...
DEVICE_RESOLUTION := 480x854                 # The Resolution of your Device
TARGET_SCREEN_HEIGHT := 854                    # The height
...
BOARD_KERNEL_CMDLINE := bootopt=64S3,62S1,62S1 androidboot.selinux=permissive
BOARD_KERNEL_BASE := 0x00008000
BOARD_KERNEL_PAGESIZE := 2048
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x0e000000 --tags_offset 0x0e000000

# Set FSTAB
TARGET_RECOVERY_FSTAB := $(LOCAL_PATH)/recovery/root/etc/recovery.fstab
                    # Remove if the device is 32-bit
             # Remove if the device is 32-bit
